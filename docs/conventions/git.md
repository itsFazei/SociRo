...
> This document was extracted from europa-component-library docs regarding git commits. Every contributor to the project should be aware of the following rules.
